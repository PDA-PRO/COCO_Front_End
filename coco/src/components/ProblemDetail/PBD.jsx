            ...
            <div className="PBD-problem">
              ...
              <div className="PBD-exBox">
                ...
                <div className="PBD-exOutput">
                  ...
                  <p className="PBD-txt2">두 정수의 합을 출력한다.</p>
        ...
        <div className="PBD-problem">
          ...
          <div className="PBD-exBox">
            ...
            <div className="PBD-exOutput">
              ...
              <p className="PBD-txt2">{detail.outputDescription}</p>
